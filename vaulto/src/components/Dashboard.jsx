...
const Dashboard = () => {
  ...
  const faqs = [
    { question: "How does Vaulto help me save?", answer: "We aggregate the best coupons and cashback offers automatically." },
  ...
  return (
    <div className="app-container dashboard-page">
      ...
      {/* Action sheet */}
      <div className={`action-sheet ${isAddMenuOpen ? 'open' : ''}`}>
        ...
        <div className="action-option" onClick={() => navigate("/manual-entry")}>
      ...
      <header className="header">
        <div className="profile-row" onClick={() => setIsProfileMenuOpen(true)}>
        ...
        <div className="icon-btn" onClick={() => setIsAddMenuOpen(true)}>
      ...
      <main className="main-content">
        {/* My Coupons */}
        <section>
          <div className="section-header"><span className="section">My Coupons</span></div>
          <div className="coupon-scroll no-scroll">
            {categories.map(cat => (
              <div key={cat.id} className={`coupon-card ${activeCategory === cat.name ? 'active' : ''}`} onClick={() => setActiveCategory(cat.name)}>
                <div className="coupon-icon-box">{cat.icon}</div>
        ...
        <section>
          ...
          <div className="wallet-scroll no-scroll">
            ...
            <div className="add-placeholder" onClick={() => setIsAddMenuOpen(true)}>
              <Plus size={22} />
            </div>
          </div>
        </section>
      ...
      <nav className="navbar">
        ...
        <div className="scan-action-btn" onClick={() => setIsAddMenuOpen(true)}>
          <Scan size={22} />
        </div>
